...
var getWSSParameters = function (req) {
  var wssHostPortPair = req.params.wshpp;
...
const getRoomParameters = function (request, roomId, clientId, isInitiator) {
  var errorMessages = [];
  var warningMessages = [];
  ...
  if (debug == 'loopback') {
    var includeLoopbackJS = '/public/webrtc/js/loopback.js';
    dtls = 'false';
  } else {
  ...
  var params = {
    ...
    'loopback_js_url' : includeLoopbackJS,
    'wss_url': wssUrl,
...
module.exports = {
  getCacheKeyForRoom: function (host, roomId) {
    return host + '/' + roomId;
  },
  generateRandom,
  getWSSParameters,
